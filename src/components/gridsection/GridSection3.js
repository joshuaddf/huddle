...
import sectionTop2 from "/public/images/bg-section-top-desktop-2.svg";
import users from "/public/images/illustration-your-users.svg";
import sectionBot2 from "/public/images/bg-section-bottom-desktop-2.svg"
  ...
  return (
    <div>
      <div className="mt-[5rem]">
        <Image className="" src={sectionTop2} width={3000} height={1000} />

        <div className="bg-Very-Pale-Blue lg:flex">
          <div className="p-[3.7rem]">
            <Image src={users} width={500} height={500} />
          </div>
      ...
      <Image className="" src={sectionBot2} width={3000} height={1000} />
    </div>
  );
};
